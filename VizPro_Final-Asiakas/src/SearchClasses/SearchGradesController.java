...
public class SearchGradesController implements Initializable {
    ...
    @FXML
    private void rateGrade(ActionEvent event) throws IOException {
        ...
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION,"Kumpi arvostellaan?",pro,book);
        String method = null;

        if(thesesTW.getSelectionModel().getSelectedItem()!=null){
